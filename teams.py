...
TEAMS = {
    ...
    "URBAN_UNDERGROUND": {
        ...
        "players": [
            ...
            # Pitchers
            {
                'id': 705310, 'legal_name': 'Andy Anderson', 'nickname': 'Ace', 'position': {'code': '1', 'name': 'Pitcher', 'abbreviation': 'P'}, 'pitchHand': {'code': 'R', 'description': 'Right'}, 'type': 'Starter', 'stamina': 80, 'fielding_ability': 0.970,
                'pitch_arsenal': {
    ...
    "NEBULA_NAVIGATORS": {
        ...
        "players": [
            ...
            # Pitchers
            {
                'id': 805410, 'legal_name': 'Roger Rocket', 'nickname': None, 'position': {'code': '1', 'name': 'Pitcher', 'abbreviation': 'P'}, 'pitchHand': {'code': 'R', 'description': 'Right'}, 'type': 'Starter', 'stamina': 72, 'fielding_ability': 0.940,
                'pitch_arsenal': {
