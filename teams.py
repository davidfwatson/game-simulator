...
TEAMS = {
    "BAY_BOMBERS": {
        ...
        "players": [
            # Batting Order
            {'id': 545101, 'legal_name': 'Leo Vance', 'nickname': None, 'position': {'code': '8', 'name': 'Center Field', 'abbreviation': 'CF'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.988, 'plate_discipline': {'Walk': 0.10, 'Strikeout': 0.15, 'HBP': 0.005}, 'batting_profile': {'contact': 0.75, 'power': 0.40, 'angle': 12.0, 'bunt_propensity': 0.4, 'stealing_tendency': 0.8, 'stealing_success_rate': 0.85}},
            {'id': 545102, 'legal_name': 'Marcus Thorne', 'nickname': None, 'position': {'code': '9', 'name': 'Right Field', 'abbreviation': 'RF'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.981, 'plate_discipline': {'Walk': 0.11, 'Strikeout': 0.14, 'HBP': 0.004}, 'batting_profile': {'contact': 0.80, 'power': 0.55, 'angle': 12.0, 'bunt_propensity': 0.1, 'stealing_tendency': 0.6, 'stealing_success_rate': 0.8}},
            {'id': 545103, 'legal_name': 'Sam Decker', 'nickname': None, 'position': {'code': '2', 'name': 'Catcher', 'abbreviation': 'C'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.995, 'catchers_arm': 0.8, 'passed_ball_rate': 0.002, 'plate_discipline': {'Walk': 0.13, 'Strikeout': 0.12, 'HBP': 0.003}, 'batting_profile': {'contact': 0.85, 'power': 0.65, 'angle': 14.0, 'bunt_propensity': 0.05, 'stealing_tendency': 0.1, 'stealing_success_rate': 0.6}},
            {'id': 545104, 'legal_name': 'Jackson Riley', 'nickname': 'Jax', 'position': {'code': 'D', 'name': 'Designated Hitter', 'abbreviation': 'DH'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.950, 'plate_discipline': {'Walk': 0.12, 'Strikeout': 0.18, 'HBP': 0.006}, 'batting_profile': {'contact': 0.70, 'power': 0.80, 'angle': 16.0, 'bunt_propensity': 0.02, 'stealing_tendency': 0.2, 'stealing_success_rate': 0.65}},
            {'id': 545105, 'legal_name': 'Caleb Jones', 'nickname': None, 'position': {'code': '6', 'name': 'Shortstop', 'abbreviation': 'SS'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.975, 'plate_discipline': {'Walk': 0.08, 'Strikeout': 0.19, 'HBP': 0.002}, 'batting_profile': {'contact': 0.65, 'power': 0.30, 'angle': 10.0, 'bunt_propensity': 0.3, 'stealing_tendency': 0.7, 'stealing_success_rate': 0.75}},
            {'id': 545106, 'legal_name': 'Nate Diaz', 'nickname': 'Kid', 'position': {'code': '4', 'name': 'Second Base', 'abbreviation': '2B'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.983, 'plate_discipline': {'Walk': 0.07, 'Strikeout': 0.10, 'HBP': 0.001}, 'batting_profile': {'contact': 0.90, 'power': 0.35, 'angle': 8.0, 'bunt_propensity': 0.5, 'stealing_tendency': 0.9, 'stealing_success_rate': 0.9}},
            {'id': 545107, 'legal_name': 'Owen Chen', 'nickname': 'Big Duck', 'position': {'code': '3', 'name': 'First Base', 'abbreviation': '1B'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.991, 'plate_discipline': {'Walk': 0.09, 'Strikeout': 0.22, 'HBP': 0.005}, 'batting_profile': {'contact': 0.60, 'power': 0.70, 'angle': 15.0, 'bunt_propensity': 0.05, 'stealing_tendency': 0.1, 'stealing_success_rate': 0.5}},
            {'id': 545108, 'legal_name': 'Miles Corbin', 'nickname': None, 'position': {'code': '5', 'name': 'Third Base', 'abbreviation': '3B'}, 'batSide': {'code': 'S', 'description': 'Switch'}, 'fielding_ability': 0.965, 'plate_discipline': {'Walk': 0.10, 'Strikeout': 0.17, 'HBP': 0.003}, 'batting_profile': {'contact': 0.72, 'power': 0.50, 'angle': 12.0, 'bunt_propensity': 0.15, 'stealing_tendency': 0.5, 'stealing_success_rate': 0.7}},
            {'id': 545109, 'legal_name': 'Grant Fisher', 'nickname': None, 'position': {'code': '7', 'name': 'Left Field', 'abbreviation': 'LF'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.980, 'plate_discipline': {'Walk': 0.09, 'Strikeout': 0.19, 'HBP': 0.004}, 'batting_profile': {'contact': 0.68, 'power': 0.60, 'angle': 13.0, 'bunt_propensity': 0.1, 'stealing_tendency': 0.4, 'stealing_success_rate': 0.7}},
            # Pitchers
            {
    ...
    "PC_PILOTS": {
        ...
        "players": [
            # Batting Order
            {'id': 625201, 'legal_name': 'Alex Chase', 'nickname': None, 'position': {'code': '4', 'name': 'Second Base', 'abbreviation': '2B'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.985, 'plate_discipline': {'Walk': 0.08, 'Strikeout': 0.16, 'HBP': 0.003}, 'batting_profile': {'contact': 0.78, 'power': 0.42, 'angle': 11.0, 'bunt_propensity': 0.4, 'stealing_tendency': 0.85, 'stealing_success_rate': 0.88}},
            {'id': 625202, 'legal_name': 'Kevin Webb', 'nickname': 'Spider', 'position': {'code': '8', 'name': 'Center Field', 'abbreviation': 'CF'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.990, 'plate_discipline': {'Walk': 0.09, 'Strikeout': 0.18, 'HBP': 0.005}, 'batting_profile': {'contact': 0.70, 'power': 0.35, 'angle': 9.0, 'bunt_propensity': 0.5, 'stealing_tendency': 0.95, 'stealing_success_rate': 0.92}},
            {'id': 625203, 'legal_name': 'Omar Ramirez', 'nickname': 'Cookie', 'position': {'code': '5', 'name': 'Third Base', 'abbreviation': '3B'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.960, 'plate_discipline': {'Walk': 0.12, 'Strikeout': 0.15, 'HBP': 0.002}, 'batting_profile': {'contact': 0.82, 'power': 0.58, 'angle': 13.0, 'bunt_propensity': 0.1, 'stealing_tendency': 0.4, 'stealing_success_rate': 0.7}},
            {'id': 625204, 'legal_name': 'Rex Power', 'nickname': 'Buzz', 'position': {'code': 'D', 'name': 'Designated Hitter', 'abbreviation': 'DH'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.940, 'plate_discipline': {'Walk': 0.13, 'Strikeout': 0.21, 'HBP': 0.008}, 'batting_profile': {'contact': 0.65, 'power': 0.85, 'angle': 18.0, 'bunt_propensity': 0.01, 'stealing_tendency': 0.1, 'stealing_success_rate': 0.5}},
            {'id': 625205, 'legal_name': 'Evan Reed', 'nickname': None, 'position': {'code': '7', 'name': 'Left Field', 'abbreviation': 'LF'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.978, 'plate_discipline': {'Walk': 0.09, 'Strikeout': 0.13, 'HBP': 0.004}, 'batting_profile': {'contact': 0.88, 'power': 0.50, 'angle': 14.0, 'bunt_propensity': 0.1, 'stealing_tendency': 0.5, 'stealing_success_rate': 0.75}},
            {'id': 625206, 'legal_name': 'Felix Washington', 'nickname': 'Nine', 'position': {'code': '3', 'name': 'First Base', 'abbreviation': '1B'}, 'batSide': {'code': 'L', 'description': 'Left'}, 'fielding_ability': 0.992, 'plate_discipline': {'Walk': 0.10, 'Strikeout': 0.20, 'HBP': 0.006}, 'batting_profile': {'contact': 0.68, 'power': 0.75, 'angle': 17.0, 'bunt_propensity': 0.05, 'stealing_tendency': 0.2, 'stealing_success_rate': 0.6}},
            {'id': 625207, 'legal_name': 'Hank Barrett', 'nickname': None, 'position': {'code': '2', 'name': 'Catcher', 'abbreviation': 'C'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.994, 'catchers_arm': 0.85, 'passed_ball_rate': 0.003, 'plate_discipline': {'Walk': 0.08, 'Strikeout': 0.15, 'HBP': 0.001}, 'batting_profile': {'contact': 0.80, 'power': 0.45, 'angle': 10.0, 'bunt_propensity': 0.25, 'stealing_tendency': 0.3, 'stealing_success_rate': 0.65}},
            {'id': 625208, 'legal_name': 'Wes Griffin', 'nickname': None, 'position': {'code': '6', 'name': 'Shortstop', 'abbreviation': 'SS'}, 'batSide': {'code': 'S', 'description': 'Switch'}, 'fielding_ability': 0.972, 'plate_discipline': {'Walk': 0.06, 'Strikeout': 0.08, 'HBP': 0.002}, 'batting_profile': {'contact': 0.92, 'power': 0.38, 'angle': 7.0, 'bunt_propensity': 0.6, 'stealing_tendency': 0.7, 'stealing_success_rate': 0.8}},
            {'id': 625209, 'legal_name': 'TJ Hawkins', 'nickname': None, 'position': {'code': '9', 'name': 'Right Field', 'abbreviation': 'RF'}, 'batSide': {'code': 'R', 'description': 'Right'}, 'fielding_ability': 0.982, 'plate_discipline': {'Walk': 0.10, 'Strikeout': 0.12, 'HBP': 0.003}, 'batting_profile': {'contact': 0.86, 'power': 0.62, 'angle': 12.0, 'bunt_propensity': 0.15, 'stealing_tendency': 0.6, 'stealing_success_rate': 0.78}},
            # Pitchers
            {
