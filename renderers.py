...
class NarrativeRenderer(GameRenderer):
    ...
    def _check_and_add_delay(self, current_end_time_iso, block_list, insert_at_index=-1):
    ...
    def render(self) -> str:
        ...
        for play in plays:
            ...
            while i < len(play_events):
                ...
                self._check_and_add_delay(event.get('endTime'), play_text_blocks, insert_at_index=insert_idx)
